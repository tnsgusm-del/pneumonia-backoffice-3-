...
# 2. 5일차 환자 관리 및 진료기록 API 명세서 원본 내용 (줄바꿈/표 완벽 보존)
...
# 3. 인코딩 에러를 완전 차단하기 위해 UTF-8 규격으로 파일을 저장합니다.
with open("docs/5일차_환자관리_API_설계.md", "w", encoding="utf-8") as f:
    f.write(markdown_content)

print("🎉 [성공] docs/5일차_환자관리_API_설계.md 파일이 줄바꿈 누락 없이 완벽하게 자동 생성되었습니다!")